package com.example.gamer.day22materialdesign;

/**
 * Created by Gamer on 8/28/2017.
 */
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView myDetails = (TextView)findViewById(R.id.subTitleDetail);
        ...
        myDetails.setText(getIntent().getStringExtra(Sport.DETAIL_KEY));
